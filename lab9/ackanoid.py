...
# screen game over
losefont = pygame.font.SysFont('Verdana', 40)
losetext = losefont.render('Game Over!', True, (0,0,0))
losetextRect = losetext.get_rect()
losetextRect.center = (W // 2, H // 2)

# screen win
winfont = pygame.font.SysFont('Verdana', 40)
wintext = winfont.render('You won!', True, (0, 0, 0))
...
def main_menu():
    menu_font = pygame.font.SysFont('Verdana', 50)
...
while not done:
  ...
  # Handling collisions with screen edges
    ...
    if ball.colliderect(paddle) and dy > 0:
        ...
        pygame.draw.rect(screen, pad_color, paddle) 

    # collisions with block
    hitIndex = ball.collidelist(block_list)
    # if ball.collidelist(block_list):
    #     game_score += 1
